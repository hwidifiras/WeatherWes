...
function FavoriteCounter({ className = '' }: FavoriteCounterProps) {
  ...
  return (
    <div className={`relative ${className}`} title={`${count} favoris`}>
      <svg className="w-6 h-6" fill={count > 0 ? "#f59e0b" : "none"} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
